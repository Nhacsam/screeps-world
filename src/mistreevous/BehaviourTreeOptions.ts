...
export interface BehaviourTreeOptions {
    ...
    /**
     * A persistent key-value store used to save node states across global resets (e.g. Screeps Memory).
     * Keys are deterministic node path strings; values are node states.
     * When provided, all node state reads and writes go through this object instead of instance variables.
     */
    memory?: Record<string, AnyState>;
}
